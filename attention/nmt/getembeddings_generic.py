  ...
  for segment in segments:
		  ...
		  segment_dict = defaultdict() 
			...
			eng_idf_score = 0.0
				...
				#eng_idf_score += 1.0/(idf_dict[engsentence[enindex]]+1)
				#eng_idf_score += idf_dict[engsentence[enindex]]
			...
			for i in range(k,j+1):
				...
				sumscore = 0.0
					...
					try:
						...
						#* abs(1.0- idf_dict_hi[hindisentence[i]]/idf_dict[engsentence[enindex]])
						#sumscore += history[i,0][enindex] * (1.0/idf_dict[engsentence[enindex]])
					except:
						sumscore += history[i,0][enindex]
			...
			score  = score / abs(hi_idf_score - eng_idf_score)
